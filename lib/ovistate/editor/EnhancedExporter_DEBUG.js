...
import { ParticleSystem as PARTICLES_LIB } from '../exporter/modules/RuntimeParticles.js';
import { SpritePlayer as SPRITES_LIB } from '../exporter/modules/RuntimeSprites.js';
import { OviStateRuntime as CORE_LIB } from '../exporter/modules/RuntimeCore.js';
import { RuntimeUI as UI_LIB } from '../exporter/modules/RuntimeUI.js';
import { BehaviorRegistry as BEHAVIORS_LIB } from '../exporter/modules/RuntimeBehaviors.js';
import TimelineSystem from '../runtime/TimelineSystem.js';
import { Ovi3DRuntime as OVI3D_LIB } from '../Ovi3D/exporter/RuntimeOvi3D.js';
import { Behavior3DRegistry as OVI3D_BEHAVIORS_LIB } from '../Ovi3D/exporter/RuntimeOvi3DBehaviors.js';
...
export default class EnhancedExporter {
    static export(simulationData) {
        ...
        const libs = {
            ...
            UI_LIB,
            BEHAVIORS_LIB,
            TIMELINE_LIB: TimelineSystem, // Direct class injection
            OVI3D_LIB,
            OVI3D_BEHAVIORS_LIB
        };
