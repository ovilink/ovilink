...
export default class OviStateEditor {
    constructor(engine) {
        ...
        this.simulationData = {
            ...
            physics: { gravity: 9.8, friction: 0.05 },
            objects: [],
            controls: [],
            graphs: [],
            globalScript: ''
    ...
    create() {
        ...
        this.physics = new PhysicsEngine({
            ...
            bounds: { width: this.runtime.width, height: this.runtime.height }
        });

        // Hook update loop
        const originalUpdate = this.runtime.update.bind(this.runtime);
        this.runtime.update = (dt) => {
            if (this.physics) this.physics.update(this.runtime.objects, dt);
        ...
        window.addEventListener('mousemove', (e) => {
            ...
            // Case B: Dragging Canvas Object
                ...
                this.draggedObject.x = snapX;
                this.draggedObject.y = snapY;

                // Keep stationary
                if (this.draggedObject.physics) this.draggedObject.physics.velocity = { x: 0, y: 0 };
            }
        });
        ...
        zone.addEventListener('drop', (e) => {
            ...
            if (category === 'behavior') {
                if (this.selectedObject) {
                    this.behaviorSystem.addBehaviorTo(this.selectedObject, type);
                    console.log('Added behavior:', type, 'to', this.selectedObject.id);
                } else {
                    alert('Select an object first to apply behavior!');
                }
            } else {
                // Objects or Controls
    ...
    selectUI(control) {
        this.deselectObject(); // Deselect physics objects
    ...
    selectObject(obj) {
        ...
        // In a real implementation we would likely mark it 'selected' in the model
        // to have the renderer draw handles.
