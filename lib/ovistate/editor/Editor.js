...
export default class OviStateEditor {
    ...
    create() {
        ...
        exportHtmlBtn.innerHTML = '📥'; // Or generic icon
        exportHtmlBtn.title = "Export HTML";
        exportHtmlBtn.style.cssText = exportBtnStyle;
        ...
        overlayZone.addEventListener('mousedown', (e) => {
            ...
            if (widget) {
                ...
                if (control) {
                    ...
                    const rect = resizableContainer.getBoundingClientRect();
                    this.dragOffset = {
                        x: ((e.clientX - rect.left) / (rect.width / resizableContainer.offsetWidth)) - control.x,
                        y: ((e.clientY - rect.top) / (rect.height / resizableContainer.offsetHeight)) - control.y
                    };
                    return;
                }
            }
