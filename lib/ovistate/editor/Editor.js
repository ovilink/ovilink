...
export default class OviStateEditor {
    ...
    selectObject(obj, toggle = false) {
        ...
        if (this.selectedObjects.size === 1) {
            Inspector.update(this.engine, Array.from(this.selectedObjects)[0]);
        } else if (this.selectedObjects.size > 1) {
            // TODO: Multi-select Inspector View
            // For now, maybe just show the last selected or a generic message?
            // Passing a special object to indicate multi-select
