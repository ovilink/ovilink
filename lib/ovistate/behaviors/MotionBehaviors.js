...
export function registerMotionBehaviors(registry) {
    ...
    registry.register('orbit', {
        ...
        category: 'motion',
        icon: '🪐',
        description: 'Orbit around a point, mouse, or object',
        parameters: {
            speed: { type: 'slider', min: -10, max: 10, default: 1, label: 'Speed' },
            radiusX: { type: 'slider', min: 0, max: 800, default: 150, label: 'Radius X (Width)' },
            radiusY: { type: 'slider', min: 0, max: 800, default: 150, label: 'Radius Y (Height)' },
            orientType: { type: 'select', options: ['none', 'face_center', 'face_forward', 'self_rotate'], default: 'none', label: 'Orientation' },
            rotateSpeed: { type: 'slider', min: 0, max: 720, default: 90, label: 'Rotate Speed (deg/s)' },
            rotateDirection: { type: 'select', options: ['clockwise', 'counter_clockwise'], default: 'clockwise', label: 'Direction' },
            centerType: { type: 'select', options: ['point', 'mouse', 'object'], default: 'point', label: 'Center Type' },
            centerX: { type: 'number', default: 400, label: 'Center X' },
            centerY: { type: 'number', default: 300, label: 'Center Y' },
