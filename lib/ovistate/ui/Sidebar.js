    ...
    static render(engine, pluginInstance) {
        engine.layoutManager.setSidebarContent(`
            ...
            <div class="sidebar-section">
                ...
                <div class="draggable-object" draggable="true" data-type="emitter">
                    <span>✨</span>
                    <span>Emitter</span>
                </div>
            </div>
            ...
            <div class="sidebar-section">
                ...
                <details open>
                    <summary style="cursor: pointer; font-weight: 600; margin-bottom: 8px; color: var(--text-primary);">🏃 Motion (8)</summary>
                    ...
                    <div class="draggable-behavior" draggable="true" data-type="orbit" style="background: #9c27b0;">
                        🔄 Orbit
                    </div>
                    <div class="draggable-behavior" draggable="true" data-type="bounce" style="background: #9c27b0;">
                        💥 Bounce
                    </div>
                </details>
                
                <details style="margin-top: 10px;">
                    <summary style="cursor: pointer; font-weight: 600; margin-bottom: 8px; color: var(--text-primary);">🔄 Transform (6)</summary>
                    ...
                    <div class="draggable-behavior" draggable="true" data-type="pulse" style="background: #2196f3;">
                        💓 Pulse
                    </div>
                </details>
            ...
            <div class="sidebar-section">
                ...
                <div style="margin-bottom: 10px;">
                    <label style="font-size: 11px; display: block; margin-bottom: 5px; color: var(--text-secondary);">Gravity (Y)</label>
                    <input type="range" id="physics-gravity" min="-20" max="20" step="0.1" value="9.8" 
                        style="width: 100%; margin-bottom: 5px;">
                    <span id="gravity-value" style="font-size: 11px; color: var(--text-primary); font-weight: 600;">9.8 m/s²</span>
                </div>
                
                <div style="margin-bottom: 10px;">
                    <label style="font-size: 11px; display: block; margin-bottom: 5px; color: var(--text-secondary);">Wind (Gravity X)</label>
                    <input type="range" id="physics-wind" min="-10" max="10" step="0.1" value="0" 
                        style="width: 100%; margin-bottom: 5px;">
                    <span id="wind-value" style="font-size: 11px; color: var(--text-primary); font-weight: 600;">0 m/s²</span>
                </div>

                <div style="margin-bottom: 10px;">
                    <label style="font-size: 11px; display: block; margin-bottom: 5px; color: var(--text-secondary);">Air Resistance</label>
                    <input type="range" id="physics-friction" min="0" max="1" step="0.01" value="0.1" 
                        style="width: 100%; margin-bottom: 5px;">
                ...
                <div style="margin-bottom: 10px;">
                    ...
                    <input type="range" id="physics-timescale" min="0.1" max="3" step="0.1" value="1" 
                        style="width: 100%; margin-bottom: 5px;">
                ...
                <div style="margin-bottom: 10px;">
                    ...
                    <input type="range" id="physics-wall-bounce" min="0" max="1.5" step="0.1" value="0.8" 
                        style="width: 100%; margin-bottom: 5px;">
        ...
        setTimeout(() => {
            ...
            if (windInput && windValue) {
                windInput.addEventListener('input', (e) => {
                    const value = parseFloat(e.target.value);
                    windValue.textContent = value.toFixed(1) + ' m/s²';
                    if (pluginInstance.activeEditor && pluginInstance.activeEditor.physics) {
                        pluginInstance.activeEditor.physics.gravityX = value;
                        pluginInstance.activeEditor.simulationData.physics.gravityX = value;
                    }
                });
            }
            ...
            if (frictionInput && frictionValue) {
                frictionInput.addEventListener('input', (e) => {
                    ...
                    if (pluginInstance.activeEditor && pluginInstance.activeEditor.physics) {
                        pluginInstance.activeEditor.physics.friction = value;
                        pluginInstance.activeEditor.simulationData.physics.friction = value;
                    }
                });
            }
            ...
            if (timeScaleInput && timeScaleValue) {
                timeScaleInput.addEventListener('input', (e) => {
                    ...
                    if (pluginInstance.activeEditor && pluginInstance.activeEditor.physics) {
                        pluginInstance.activeEditor.physics.timeScale = value;
                        pluginInstance.activeEditor.simulationData.physics.timeScale = value;
                    }
                });
            }
            ...
            if (wallBounceInput && wallBounceValue) {
                wallBounceInput.addEventListener('input', (e) => {
                    ...
                    if (pluginInstance.activeEditor && pluginInstance.activeEditor.physics) {
                        pluginInstance.activeEditor.physics.wallBounciness = value;
                        pluginInstance.activeEditor.simulationData.physics.wallBounciness = value;
                    }
                });
            }
