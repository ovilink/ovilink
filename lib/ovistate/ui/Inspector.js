...
const BEHAVIOR_DESCRIPTIONS_BN = {
    // Motion
    'wiggle': 'এলোমেলোভাবে কাঁপতে থাকে (Random Jitter)।',
    'shake': 'ভূমিকম্পের মতো কাঁপতে থাকে।',
    'float': 'বাতাসে ভাসার মতো ধীরে ওঠানামা করে।',
    'spiral': 'সর্পিল বা প্যাঁচানো পথে ঘোরে।',
    'zigzag': 'আঁকাবাঁকা পথে (Zigzag) চলে।',
    'wave_motion': 'ঢেউয়ের মতো (Sine Wave) পথে চলে।',
    'bounce': 'বাউন্স করে বা লাফায়।',
    'orbit': 'অন্য বস্তুর চারপাশে ঘোরে।',
    'scroller': 'ব্যাকগ্রাউন্ড বা দৃশ্যপট অবিরাম চলতে থাকে (Infinite Scroll)।',
    'state_switcher': 'অবস্থার (State) পরিবর্তন নিয়ন্ত্রণ করে।',

    // Brim
    'tale_pop': 'গল্পের বা বার্তার পপ-আপ দেখায়।',
    'progress_tracker': 'স্কোর, হেলথ বা প্রগেস ট্র্যাক করার জন্য।',

    // Interactive
    'click_response': 'ক্লিক করলে প্রতিক্রিয়া দেখায় (যেমন লাফানো)।',
    'hover_grow': 'মাউস উপরে নিলে বড় হয়।',
    'magnet': 'মাউসের দিকে আকর্ষিত হয়।',
    'repel': 'মাউস থেকে দূরে সরে যায়।',
    'follow_mouse_smooth': 'মাউসকে মসৃণভাবে অনুসরণ করে।',
    'collision_trigger': 'অন্য বস্তুর সাথে ধাক্কা লাগলে কাজ করে।',
    'look_at': 'মাউস বা লক্ষ্যের দিকে তাকিয়ে থাকে।',
    'spring_follow': 'স্প্রিং বা রাবারের মতো মাউসকে অনুসরণ করে।',
    'draggable': 'মাউস দিয়ে টেনে সরানো যায় এবং ছুড়ে ফেলা যায়।',
    'parallax': 'মাউস নড়াচড়ার সাথে গভীরতার (Depth) অনুভূতি তৈরি করে।',
    'drag_reactor': 'টেনে অন্য বস্তুকে নিয়ন্ত্রণ করা যায়।',
    'impulse': 'একশন এর মাধ্যমে ধাক্কা বা বল প্রয়োগ করে।',

    // Logic
    'timer_events': 'নির্দিষ্ট সময় পর কাজ করে।',
    'value_threshold': 'কোনো মান (Value) নির্দিষ্ট সীমার কম/বেশি হলে কাজ করে।',

    // Path
    'figure_eight': '8-এর আকৃতিতে ঘোরে।',
    'circle_path': 'বৃত্তাকার পথে ঘোরে।',
    'random_walk': 'এলোমেলোভাবে ঘুরে বেড়ায়।',
    'bounce_path': 'কোনাকুনি ভাবে বাউন্স করে চলে।',
    'follow_path': 'নির্দিষ্ট আঁকানো পথ অনুসরণ করে।',
    'scrub_path': 'পথের অবস্থান স্লাইডার দিয়ে নিয়ন্ত্রণ করা যায়।',

    // Physics
    'solid_body': 'বস্তুটি কঠিন বাধা হিসেবে কাজ করে।',
    'timeline_physics_bridge': 'টাইমলাইন এনিমেশনের সাথে ফিজিক্স বা বাধা চালু রাখে।',

    // Text
    'typewriter': 'টাইপরাইটারের মতো অক্ষরগুলো একে একে আসে।',
    'pulse_text': 'লেখার আকার হৃৎস্পন্দনের মতো ছোট-বড় হয়।',
    'rainbow_text': 'লেখার রঙ রংধনুর মতো পরিবর্তিত হতে থাকে।',

    // Transform
    'rotate_continuous': 'অবিরাম ঘুরতে থাকে।',
    'scale_breath': 'শ্বাস-প্রশ্বাসের মতো ধীরে বড়-ছোট হয়।',
    'color_cycle': 'বস্তুর রঙ চক্রাকারে পরিবর্তিত হয়।',
    'glow': 'উজ্জ্বল আভা (Glow) ছড়ায় এবং নিভে।',
    'fade_cycle': 'বারবার দৃশ্যমান ও অদৃশ্য হতে থাকে।',
    'pulse': 'আকার ছোট-বড় হতে থাকে (Pulse)।',
    'fade': 'ধীরে ধীরে মিলিয়ে যায় বা ভেসে ওঠে।',
    'wheel_rolling': 'চাকার মতো গড়াতে থাকে (চলাচলের সাথে)।',

    // Trigger
    'action_animation': 'একশনের মাধ্যমে এনিমেশন ট্রিগার করে (যেমন ঝাকুনি)।',
    'play_animation': 'নির্দিষ্ট এনিমেশন ক্লিপ চালায়।',

    // Legacy / Generic Fallbacks
    'orbit_around': 'বস্তুটি অন্য একটি বিন্দুর চারপাশে ঘোরে।',
    'rotate': 'বস্তুটি নিজের অক্ষের চারপাশে ঘোরে।',
    'physics': 'বস্তুর উপর পদার্থবিজ্ঞানের নিয়ম প্রয়োগ করে।',
    'platform': 'বস্তুটি একটি প্ল্যাটফর্ম হিসেবে কাজ করবে।',
    'destroy_bound': 'সীমানার বাইরে গেলে বস্তুটি ধ্বংস হয়ে যাবে।',
    'elliptical_motion': 'বস্তুটি উপবৃত্তাকার পথে ঘোরে।',
    'eight_direction': 'কীবোর্ড দিয়ে ৮ দিকে চলাচল করা যায়।',
    'platformer': 'প্ল্যাটফর্মার গেমের মতো চলাচল (Jump, Run)।',
    'car_control': 'গাড়ির মতো চলাচল (Accelerate, Turn)।',
    'grid_movement': 'গ্রিড বা ছক অনুযায়ী চলাচল করে।',
    'blink': 'বস্তুটি নিভু নিভু (Blink) করে।',
    'counter': 'সংখ্যা গণনা বা স্কোর দেখানোর জন্য।',
    'timer': 'সময় গণনা (Countdown/Stopwatch)।',
    'bullet': 'বন্দুকের গুলির মতো সোজা ও দ্রুত চলে।',
    'wrap_around': 'এক পাশ দিয়ে বেরিয়ে অন্য পাশ দিয়ে ফিরে আসে।',
    'steering': 'স্মুথ বা মসৃণভাবে লক্ষ্যবস্তুর দিকে ঘোরে।'
};
...
export default class Inspector {
    ...
    /**
     * Updates an object property and refreshes UI
     * Centralized method for all property changes
     * HOOK: Auto-Key Logic
     */
    static updateProperty(engine, property, value, objectId = null) {
        if (!engine || !engine.runtime) return;

        const targetId = objectId || (engine.selectedObject ? engine.selectedObject.id : null);
        if (!targetId) return;

        const obj = engine.runtime.getObject(targetId);
        if (!obj) return;

        // Apply Value
        // Handle nested properties (e.g., 'physics.density')
        ...
        // --- AUTO-KEY LOGIC ---
        // If Timeline has Auto-Key enabled, record this change
        if (engine.timeline && engine.timeline.autoKey) {
            // Only animatable properties
            const animatable = ['x', 'y', 'rotation', 'scale', 'opacity', 'width', 'height', 'radius'];
            // Normalize property check
            const propKey = property.includes('.') ? property.split('.').pop() : property;

            if (animatable.includes(propKey)) {
                if (engine.runtime.timelineSystem) {
                    engine.runtime.timelineSystem.addKeyframe(obj, propKey, value);
                    // Refresh Timeline UI
                    if (engine.timeline.isVisible) engine.timeline.draw();
                }
            }
        }

        // Refresh UI
        // If we are updating the selected object, re-render might be needed?
        // Usually, inputs update themselves via event listeners, but this helper
        // is called from OTHER places too (like drag).
        // If called from drag, we might need to sync Inspector fields if open.
        // Assuming Engine loop handles rendering canvas.
    }
    ...
    static getBehaviorDescription(id) {
        return BEHAVIOR_DESCRIPTIONS_BN[id] || 'Behavior settings and description';
    }
        ...
        return `
            <div style="padding: 15px; color: var(--text-primary);">
                <div class="inspector-section">
                    ...
                    <div class="property-control">
                        <div class="property-label">Link to Parent</div>
                ...
                <div class="inspector-section">
                    ...
                    <div class="property-control">
                        <div class="property-label">Follow Path</div>
                        <select id="prop-pathId" data-property="pathId" style="width: 100%; padding: 5px; background: var(--bg-secondary); border: 1px solid var(--border-color); color: var(--text-primary); border-radius: 3px; font-size: 11px;">
                            ${this.generatePathOptions(window.oviEditor, data)}
                        </select>
                    </div>
                    ${data.pathId ? `
                        <div style="margin-top: 8px;">
                            ${this.createNumberControl('Path Progress', 'pathProgress', data.pathProgress || 0, 0, 1, 0.01)}
                            ${this.createToggleControl('Orient to Path', 'orientToPath', data.orientToPath || false)}
                        </div>
                    ` : ''}
                </div>
                ...
                <div class="inspector-section">
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                        <div style="flex: 1;">${this.createNumberControl('X', 'x', data.x, -2000, 5000)}</div>
                        <div style="flex: 1;">${this.createNumberControl('Y', 'y', data.y, -2000, 5000)}</div>
                    </div>
                    <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                        <div style="flex: 1;">${this.createNumberControl('Rotation', 'rotation', data.rotation || 0, -360, 360)}</div>
                        <div style="flex: 1;">${this.createNumberControl('Scale', 'scale', data.scale !== undefined ? data.scale : 1, 0.01, 10, 0.01)}</div>
                    </div>
                    <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                        <div style="flex: 1;">${this.createNumberControl('Z-Index', 'zIndex', data.zIndex || 0, -100, 1000)}</div>
                        <div style="flex: 1;">${this.createNumberControl('Opacity', 'opacity', data.opacity !== undefined ? data.opacity : 1, 0, 1, 0.01)}</div>
                    </div>
                    ${data.type === 'circle' ?
                    this.createNumberControl('Radius', 'radius', data.radius || 30, 5, 200) :
                    (data.type === 'text' || data.type === 'symbol' || data.type === 'variable' || data.type === 'timer' ? '' :
                        `<div style="display: flex; gap: 8px;">
                            <div style="flex: 1;">${this.createNumberControl('Width', 'width', data.width || 60, 10, 3000)}</div>
                            <div style="flex: 1;">${this.createNumberControl('Height', 'height', data.height || 60, 10, 3000)}</div>
                        </div>`)
                }
                </div>
                ...
                <div class="inspector-section">
                    ...
                    <div class="inspector-section" style="padding: 0;">
                        <div class="property-label" style="margin-bottom: 5px;">Path Points</div>
                        <div style="max-height: 150px; overflow-y: auto; background: var(--bg-secondary); border-radius: 3px; padding: 4px;">
                            ${(data.points || []).map((p, i) => `
                                <div class="path-point-item" style="display: flex; gap: 4px; align-items: center; margin-bottom: 2px; padding: 2px 4px; background: rgba(0,0,0,0.1); border-radius: 2px;">
                                    <span style="font-size: 10px; color: var(--text-secondary); min-width: 15px;">${i}</span>
                                    <input type="number" class="point-coord" data-index="${i}" data-axis="x" value="${Math.round(p.x)}" style="width: 45px; padding: 2px; background: var(--bg-input); border: 1px solid var(--border-color); color: var(--text-primary); font-size: 10px;">
                                    <input type="number" class="point-coord" data-index="${i}" data-axis="y" value="${Math.round(p.y)}" style="width: 45px; padding: 2px; background: var(--bg-input); border: 1px solid var(--border-color); color: var(--text-primary); font-size: 10px;">
                                    <div style="flex: 1;"></div>
                                    <button class="move-point-btn" data-index="${i}" data-dir="-1" style="background: none; border: none; color: var(--text-secondary); cursor: pointer; padding: 0 4px;">↑</button>
                                    <button class="move-point-btn" data-index="${i}" data-dir="1" style="background: none; border: none; color: var(--text-secondary); cursor: pointer; padding: 0 4px;">↓</button>
                                    <button class="remove-point-btn" data-index="${i}" style="background: none; border: none; color: #e74c3c; cursor: pointer; padding: 0 4px;">&times;</button>
                                </div>
                            `).join('')}
                        </div>
                        <button id="add-path-point-btn" style="width: 100%; margin-top: 8px; padding: 4px; background: var(--bg-input); border: 1px dashed var(--border-color); color: var(--text-secondary); cursor: pointer; font-size: 10px;">+ Add Point at End</button>
                    </div>
                ...
                <div class="inspector-section">
                    ...
                    ${Array.from(data.behaviors || []).map(b => `
                        <div title="${this.getBehaviorDescription(b)}" style="background: var(--bg-secondary); padding: 6px 8px; border-radius: 3px; margin-bottom: 4px; font-size: 11px; display: flex; justify-content: space-between; align-items: center; cursor: help;">
                            <span style="font-weight: 500;">${this.getBehaviorLabel(b)}</span>
    ...
    static buildUIInspector(data) {
        ...
        controls += `
            <div class="inspector-section">
                <div class="section-title">Layout & Transform</div>
                <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                    <div style="flex: 1;">${this.createNumberControl('X', 'x', data.x, -2000, 5000)}</div>
                    <div style="flex: 1;">${this.createNumberControl('Y', 'y', data.y, -2000, 5000)}</div>
                </div>
    ...
    static renderBehaviorSettings(data) {
        ...
        `;
            ...
            Object.entries(behavior.parameters).forEach(([paramName, paramDef]) => {
                ...
                if (behaviorId === 'look_at' || behaviorId === 'follow_target' || behaviorId === 'follow_mouse_smooth' || behaviorId === 'spring_follow') {
                    const targetType = editor.behaviorSystem.registry.getParameter(data, behaviorId, 'targetType') || 'mouse';
                    if (paramName === 'targetId' && targetType !== 'object') containerStyle = "display: none;";

                    if (behaviorId === 'follow_target') {
                        const moveMode = editor.behaviorSystem.registry.getParameter(data, behaviorId, 'moveMode');
                        if (moveMode === 'spring') {
                            if (paramName === 'speed' || paramName === 'smoothness') containerStyle = "display: none;";
                        } else {
                            if (paramName === 'stiffness' || paramName === 'damping') containerStyle = "display: none;";
                        }
                    }
                }
                if (behaviorId === 'orbit') {
                    const centerType = editor.behaviorSystem.registry.getParameter(data, behaviorId, 'centerType') || 'point';
                    if ((paramName === 'centerX' || paramName === 'centerY') && centerType !== 'point') containerStyle = "display: none;";
                    if (paramName === 'targetId' && centerType !== 'object') containerStyle = "display: none;";

                    const orientType = editor.behaviorSystem.registry.getParameter(data, behaviorId, 'orientType') || 'none';
                    if ((paramName === 'rotateSpeed' || paramName === 'rotateDirection') && orientType !== 'self_rotate') containerStyle = "display: none;";
                }
            ...
            <div class="property-control" style="${containerStyle}" data-param-container="${paramName}">
                            <div class="property-label">
                                ...
                                <span class="property-value">${Number(currentValue).toFixed(paramDef.step < 1 ? 2 : 1)}</span>
                            </div>
                            <input type="range" 
                                class="behavior-param-slider inspector-slider"
                                data-behavior="${behaviorId}"
                                data-param="${paramName}"
                                min="${paramDef.min || 0}"
                                max="${paramDef.max || 5000}"
                                step="${paramDef.step || (paramDef.max <= 1 ? 0.01 : 1)}"
                                value="${currentValue}"
                                style="width: 100%;">
                        </div>
        `;
            ...
            `;
                    ...
                    html += `
            <div class="property-control" style="${containerStyle}">
                <div class="toggle-container" style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                    <span style="font-size: 11px;">${paramDef.label}</span>
                    <div class="toggle-switch behavior-param-toggle ${currentValue ? 'active' : ''}"
                        data-behavior="${behaviorId}"
                        data-param="${paramName}">
                    </div>
                </div>
        ...
        `;
                    ...
                    html += `
            <div class="property-control" style="${containerStyle}">
                            <div class="property-label" style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 4px;">
                                <span>${paramDef.label}</span>
                                <label class="import-btn" style="cursor:pointer; color:#3498db; font-size:10px; border:1px solid #3498db; padding:2px 6px; border-radius:3px; background: rgba(52, 152, 219, 0.1);">
                                    📂 Import SVG
                                    <input type="file" 
                                        class="behavior-file-import"
                                        data-behavior="${behaviorId}"
                                        data-param="${paramName}"
                                        accept=".svg"
                                        style="display:none;">
                            ...
                            <textarea 
                                ...
                                data-behavior="${behaviorId}"
                                data-param="${paramName}"
                                style="width: 100%; height: 60px; padding: 4px; background: var(--bg-secondary); border: 1px solid var(--border-color); color: var(--text-primary); border-radius: 3px; font-size: 11px; resize: vertical;">${currentValue || paramDef.default || ''}</textarea>
                        </div>
        `;
                } else if (paramDef.type === 'select') {
                    let options = '';

                    // Handle dynamic options (string like 'objects:path')
                    if (typeof paramDef.options === 'string') {
                        if (paramDef.options.startsWith('objects:')) {
                            const filterType = paramDef.options.split(':')[1];
                            options = '<option value="">(None)</option>';
                            editor.runtime.objects.forEach(obj => {
                                if (obj.type === filterType || filterType === 'all') {
                                    const label = `${obj.name || obj.id.substring(0, 8)}`;
                                    options += `<option value="${obj.id}" ${currentValue === obj.id ? 'selected' : ''}>${label}</option>`;
                                }
                            });
                        }
                    }
                    // Handle static array options
                    else if (Array.isArray(paramDef.options)) {
    ...
    static attachEventListeners(engine) {
        ...
        document.querySelectorAll('input[type="color"]').forEach(input => {
            ...
            // HISTORY: Save on change
            input.addEventListener('change', () => {
                if (window.oviEditor && window.oviEditor.saveState) window.oviEditor.saveState();
            });
        });
        ...
        const handleNumericInput = (e) => {
            ...
            // Special handling for pathProgress - update position along path
            if (prop === 'pathProgress' && editor.selectedObject && editor.selectedObject.pathId && editor.runtime) {
                const obj = editor.selectedObject;
                const pathObj = editor.runtime.getObject(obj.pathId);
                if (pathObj && pathObj.points && pathObj.points.length > 0) {
                    const tension = pathObj.tension !== undefined ? pathObj.tension : 0.5;
                    const pos = editor.runtime.getSplinePoint(pathObj.points, tension, val, pathObj.closed);
                    ...
                    // Orient if enabled
                    if (obj.orientToPath && val < 1) {
                        const nextT = Math.min(1, val + 0.01);
                        const nextPos = editor.runtime.getSplinePoint(pathObj.points, tension, nextT, pathObj.closed);
                        const angle = Math.atan2(nextPos.y - pos.y, nextPos.x - pos.x) * 180 / Math.PI;
                        obj.rotation = angle;
                    }

                    if (editor.runtime) editor.runtime.requestRender();
                }
            }
        ...
        document.querySelectorAll('.inspector-slider, .inspector-number').forEach(el => {
            ...
            // HISTORY: Save state on 'change' (commit)
        ...
        // Behavior parameter toggles (New!)
        document.querySelectorAll('.behavior-param-toggle').forEach(toggle => {
            toggle.addEventListener('click', (e) => {
                const behaviorId = e.target.dataset.behavior;
                const paramName = e.target.dataset.param;
                e.target.classList.toggle('active');
                const value = e.target.classList.contains('active');

                editor.behaviorSystem.registry.setParameter(editor.selectedObject, behaviorId, paramName, value);

                // Conditional visibility logic (like loop Delay)
                if (paramName === 'loop') {
                    const section = e.target.closest('.behavior-section') || e.target.closest('.inspector-section');
                    if (section) {
                        const loopDelayContainer = section.querySelector('[data-param-container="loopDelay"]');
                ...
                // Refresh for other conditional params
                setTimeout(() => Inspector.update(engine, editor.selectedObject), 50);
            });
        });

        // Behavior File Import (SVG)
        document.querySelectorAll('.behavior-file-import').forEach(input => {
            input.addEventListener('change', (e) => {
                ...
                reader.onload = (loadEvent) => {
                    ...
                    // 1. Update Registry
                    editor.behaviorSystem.registry.setParameter(editor.selectedObject, behaviorId, paramName, content);

                    // 2. Update Textarea UI
                    const textarea = document.querySelector(`.behavior-param-text[data-behavior="${behaviorId}"][data-param="${paramName}"]`);
                    if (textarea) {
                        textarea.value = content;
                    }

                    // 3. Clear input so same file can be selected again
                    e.target.value = '';
                };
        ...
        const pathIdSelect = document.getElementById('prop-pathId');
        if (pathIdSelect) {
            pathIdSelect.addEventListener('change', (e) => {
                const obj = editor.selectedObject;
                if (obj && !obj._updatingPath) {
                    obj._updatingPath = true; // Prevent re-trigger during Inspector.update()
                    obj.pathId = e.target.value || null;

                    if (obj.pathId && editor.runtime) {
                        const pathObj = editor.runtime.getObject(obj.pathId);
                        console.log('🛣️ Path Object:', pathObj);
                        console.log('🛣️ Path Points:', pathObj?.points);

                        if (pathObj && pathObj.points && pathObj.points.length > 0) {
                            // AUTO-DISABLE PHYSICS to prevent gravity interference
                            if (obj.physics && obj.physics.enabled) {
                                obj.physics.enabled = false;
                                console.log('🔒 Physics auto-disabled for path following');
                                if (window.showOviToast) {
                                    window.showOviToast('⚙️ Physics disabled for path following', 'info');
                                }
                            }

                            // SNAP TO PATH
                            const progress = obj.pathProgress || 0;
                            const tension = pathObj.tension !== undefined ? pathObj.tension : 0.5;

                            console.log('🛣️ Calculating position with:', { progress, tension, pointsCount: pathObj.points.length });

                            const pos = editor.runtime.getSplinePoint(pathObj.points, tension, progress, pathObj.closed);

                            console.log('🛣️ Calculated position (relative):', pos);
                            console.log('🛣️ Path offset:', { x: pathObj.x, y: pathObj.y });
                            ...
                            console.log('🛣️ World position:', worldPos);
                            console.log('🛣️ Setting object position from', { x: obj.x, y: obj.y }, 'to', worldPos);

                            obj.x = worldPos.x;
                            obj.y = worldPos.y;

                            // Orient if enabled
                            if (obj.orientToPath && progress < 1) {
                                const nextT = Math.min(1, progress + 0.01);
                                const nextPos = editor.runtime.getSplinePoint(pathObj.points, tension, nextT, pathObj.closed);
                                const angle = Math.atan2(nextPos.y - pos.y, nextPos.x - pos.x) * 180 / Math.PI;
                                obj.rotation = angle;
                            }
                        ...
                        // RE-ENABLE PHYSICS when path is removed
                        if (obj.physics && obj.physics.enabled === false && !obj._physicsManuallyDisabled) {
                            obj.physics.enabled = true;
                            console.log('🔓 Physics re-enabled after path removal');
                            if (window.showOviToast) {
                                window.showOviToast('✅ Physics re-enabled', 'success');
                            }
                        }
                    }

                    // Render immediately before updating Inspector
                    if (editor.runtime) editor.runtime.requestRender();

                    // Update Inspector UI
                    setTimeout(() => {
                        Inspector.update(engine, obj);
                        obj._updatingPath = false; // Reset flag after update
                    }, 10);
                }
            });
        }
        ...
        document.querySelectorAll('.point-coord').forEach(input => {
            input.addEventListener('change', (e) => {
                ...
                if (obj && obj.points && obj.points[index]) {
                    obj.points[index][axis] = val;
                    if (editor.runtime) editor.runtime.requestRender();
                }
            });
        });

        document.querySelectorAll('.move-point-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                const index = parseInt(e.target.dataset.index);
                ...
                if (obj && obj.points) {
                    ...
                    if (next >= 0 && next < obj.points.length) {
                        const temp = obj.points[index];
                        obj.points[index] = obj.points[next];
                        obj.points[next] = temp;
                        Inspector.update(engine, obj);
                        if (editor.runtime) editor.runtime.requestRender();
                    }
                }
        ...
        const addPointBtn = document.getElementById('add-path-point-btn');
        if (addPointBtn) {
            addPointBtn.addEventListener('click', () => {
                const obj = editor.selectedObject;
                if (obj && obj.points) {
                    const last = obj.points[obj.points.length - 1];
                    obj.points.push({ x: last.x + 50, y: last.y + 50 });
                    Inspector.update(engine, obj);
                    if (editor.runtime) editor.runtime.requestRender();
                }
            });
    ...
    static generateParentOptions(editor, currentObj) {
        ...
        editor.runtime.objects.forEach(obj => {
            ...
            // 2. Cannot be a descendant (avoids loops)
            let isDescendant = false;
            let temp = obj.parent;
            const visited = new Set();
            while (temp) {
                if (temp === currentObj.id) {
                    isDescendant = true;
                    break;
                }
                if (visited.has(temp)) break;
                visited.add(temp);
                const p = editor.runtime.getObject(temp);
                temp = p ? p.parent : null;
            }
    ...
    static generatePathOptions(editor, currentObj) {
        if (!editor || !editor.runtime || !editor.runtime.objects) return '<option value="">(None)</option>';

        let options = '<option value="">(None)</option>';
        editor.runtime.objects.forEach(obj => {
            if (obj.type === 'path' || obj.type === 'vector_path') {
                const label = `🛣️ ${obj.name || obj.id.substring(0, 8)}`;
                options += `<option value="${obj.id}" ${currentObj.pathId === obj.id ? 'selected' : ''}>${label}</option>`;
            }
        });
        return options;
    }
    ...
    /**
     * Generate behavior options grouped by category
     */
    static generateBehaviorOptions(editor) {
        if (!editor || !editor.runtime || !editor.runtime.behaviorRegistry) {
            return '<option value="">No behaviors available</option>';
        }

        const registry = editor.runtime.behaviorRegistry;
        const categories = {
            'motion': [],
            'transform': [],
            'interactive': [],
        ...
        registry.getAll().forEach(behavior => {
            const cat = behavior.category || 'other';
            if (!categories[cat]) categories[cat] = [];
            categories[cat].push(behavior);
        });

        let html = '';
        Object.entries(categories).forEach(([cat, behaviors]) => {
            // Skip the 'hidden' category completely
            if (cat === 'hidden') return;

            if (behaviors.length > 0) {
                html += `<optgroup label="${cat.toUpperCase()}">`;
                behaviors.forEach(b => {
                    const desc = this.getBehaviorDescription(b.id); // Get Bengali description
                    // Removed icon, added title for hover tooltip
                    html += `<option value="${b.id}" title="${desc}">${b.name}</option>`;
                });
                html += `</optgroup>`;
            }
        });

        return html || '<option value="">No behaviors available</option>';
    }

    /**
     * Get formatted behavior label with icon
     */
    static getBehaviorLabel(behaviorId) {
        // Try to get from registry if available
        if (window.oviEditor && window.oviEditor.runtime && window.oviEditor.runtime.behaviorRegistry) {
            const behavior = window.oviEditor.runtime.behaviorRegistry.get(behaviorId);
            if (behavior) {
                return `${behavior.icon || '●'} ${behavior.name}`;
            }
        }

        // Fallback: Format the ID
        return behaviorId.split('_').map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(' ');
    }
}
