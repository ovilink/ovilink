...
export default class OviCanvas {
    ...
    init() {
        ...
        this.svgLayer.style.zIndex = '100'; // Ensure visibility over everything
    ...
    drawConnection(x1, y1, x2, y2, color = '#555') {
        ...
        path.style.pointerEvents = 'all'; // Enable individual path clicks
    ...
    /**
     * Clears all connection lines from the SVG layer.
     */
    clearConnections() {
